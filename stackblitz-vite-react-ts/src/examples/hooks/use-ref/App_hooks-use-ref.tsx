...
export default function App() {
  ...
  return (
    <>
      ...
      <div ref={testDivRef} className="testBlock">test block</div>
      <p> Or you can provide a function that React will call with the DOM element
        or component instance when it is mounted or updated.
        {showInput && <input ref={setInputFn} type="text" />}
      </p>
      <p>On the input <button onClick={()=>setShowInput(false)}>removal</button> you should see the cleanup
      function executed.</p>
      ...
      React's ref system isn't aware of this change.</p>
    </>
  );
}
